...
@bp.route('/comments', methods=['POST'])  #comment
@login_required
def comment():
  data = request.get_json()
  db = get_db()
...
@bp.route('/posts/upvote', methods=['PUT']) #upvote
@login_required
def upvote():
  data = request.get_json()
  db = get_db()
...
@bp.route('/posts', methods=['POST']) #newpost
@login_required
def create():
  data = request.get_json()
  db = get_db()
...
@bp.route('/posts/<id>', methods=['PUT']) #editpost
@login_required
def update(id):
  data = request.get_json()
  db = get_db()
